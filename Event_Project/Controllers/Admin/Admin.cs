...
namespace Event_Project.Controllers.Admin.Admin
{
    ...
    public class Admin : Controller
    {
        ...
        public Admin(CookieHelper cookieHelper, RequestHelper requestHelper)
        {
    ...
    {
        internal void SignOut(HttpContext httpContext, string v)
        {
    ...
    {
        internal object Action<T>(string v, object get, object value)
        {
            throw new NotImplementedException();
        }
    }
